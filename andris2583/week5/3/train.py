...
# Data loading
train_data = pd.read_parquet('../../train.parquet', columns=['context', 'question', 'answerable', 'answer', 'lang','answer_inlang'], filters=[('lang', 'in', ['fi','ru','ja']),('answer_inlang', '!=', 'null')])
valid_data = pd.read_parquet('../../validation.parquet', columns=['context', 'question', 'answerable', 'answer', 'lang','answer_inlang'], filters=[('lang', 'in', ['fi','ru','ja']),('answer_inlang', '!=', 'null')])
